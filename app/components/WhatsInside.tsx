...
const WhatsInside = () => {
  return (
    <section className="flex h-full flex-col justify-center gap-y-12 bg-primary-red px-8 py-10 md:px-20 lg:flex-row lg:items-stretch 2xl:px-60">
      ...
      <article className="flex flex-1 flex-col items-start justify-center">
        ...
        <article className="flex flex-col justify-between">
          <p className="mg:mb-0 font-nunito mb-16 mt-4 text-background-white">
            ...
            eros feugiat sit amet. Sed vehicula ante sed lacus tempor
            scelerisque. Phasellus blandit arcu diam, sit amet consequat sapien
            aliquam vel. Vestibulum porta orci et ligula iaculis sodales. Nulla
            scelerisque eros a blandit luctus..
          </p>
          <WaitingListBtn color="background-white" textColor="primary-red" />
        </article>
      </article>
    </section>
  );
