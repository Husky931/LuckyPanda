      ...
      <section className="flex h-full flex-col justify-center gap-y-12 px-8 py-10 md:px-20 lg:flex-row lg:items-stretch 2xl:px-60">
        ...
        <article className="relative flex flex-1 flex-col items-start justify-center">
          ...
          <article className="flex flex-col justify-between">
            <p className="mg:mb-0 font-nunito mb-16 mt-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vitae
              urna id ipsum cursus ornare nec non diam. Phasellus congue mi ut
              ex efficitur tristique. Sed lacinia pharetra tortor, vitae
              fringilla eros feugiat sit amet. Sed vehicula ante sed lacus
              tempor scelerisque. Phasellus blandit arcu diam, sit amet
              consequat sapien aliquam vel. Vestibulum porta orci et ligula
              iaculis sodales. Nulla scelerisque eros a blandit luctus..
            </p>
            <WaitingListBtn />
          </article>
        </article>
