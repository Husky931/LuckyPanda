        ...
        >
          <ul className="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:p-0 rtl:space-x-reverse">
            <li>
              <a
                href="#"
                className="md:text-text-redPrimary block rounded-sm bg-primary-red px-3 py-2 text-white md:bg-transparent md:p-0"
                aria-current="page"
              >
                Home
              </a>
            ...
            <li>
              <a
                href="#"
                className="md:hover:text-text-redPrimary block rounded-sm px-3 py-2 text-gray-900 hover:bg-gray-100 md:p-0 md:hover:bg-transparent"
              >
                About
              </a>
            </li>
